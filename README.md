...
25. Какие способы создание объекта существуют
...
26. Какие значения будут являться false значениями
    
    ```jsx
    null, undefined, NaN, 0, "", false, BigInt(0)
    ```
    
27. Разница между синхронными и асинхронными функциями
...
31. **Разница между Promise.all(), Promise.allSettled(), Promise.any() и Promise.race()?**
...
32. Как использовать async/await для ассинхронных запросов
...
33. **Для чего используется цикл for…of?**
