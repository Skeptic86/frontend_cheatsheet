...
61.  Что такое сборщик мусора (garbage collector) в JS и зачем он нужен? Когда вызывается?
    ...
    6. GC вызывается когда движку не хватает памяти или в периоды простоя (алгоритм недетерминирован).
    ```

62. Что такое Web Components и зачем они нужны?
    ```jsx
...
63.  Что такое Shadow DOM и зачем он используется?
    ```jsx
...
64. Что такое slot и как он используется для проекции контента в Shadow DOM?
    ```
...
65. Что такое и зачем нужен requestAnimationFrame?
    ```
