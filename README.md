...
26. Какие способы создание объекта существуют
...
27. Какие значения будут являться false значениями
    
    ```jsx
    null, undefined, NaN, 0, "", false, BigInt(0)
    ```
    
28. Разница между синхронными и асинхронными функциями
...
32. **Разница между Promise.all(), Promise.allSettled(), Promise.any() и Promise.race()?**
...
33. Как использовать async/await для ассинхронных запросов
...
34. **Для чего используется цикл for…of?**
