...
59. Что такое сборщик мусора (garbage collector) в JS и зачем он нужен? Когда вызывается?
    ```jsx
...
60. Что такое Web Components и зачем они нужны?
    ```jsx
...
61.  Что такое Shadow DOM и зачем он используется?
    ```jsx
...
63. Что такое slot и как он используется для проекции контента в Shadow DOM?
    ```
